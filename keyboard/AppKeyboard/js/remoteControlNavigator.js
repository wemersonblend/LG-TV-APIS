(function(_global) {
    ...
    RemoteControlNavigator.prototype.init = function(options) {

        console.log('RemoteControlNavigator', options);
        ...
        _onKeyReturn = options.onKeyReturn || function(){};
        _onKeyEnter = options.onKeyEnter || function(){};
        _onSetFocus = options.onSetFocus || function(){};
        _onSetInput = options.onSetInput || function(){};
